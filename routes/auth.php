...
$forgotPasswordPath = AuthRouteHelper::getForgotPasswordPath();
$resetPasswordPath = AuthRouteHelper::getResetPasswordPath();

Route::middleware('guest')->group(function () use ($registerPath, $loginPath, $forgotPasswordPath) {
    ...
    Route::get($forgotPasswordPath, [PasswordResetLinkController::class, 'create'])
        ->name('password.request');

    Route::post($forgotPasswordPath, [PasswordResetLinkController::class, 'store'])
        ->name('password.email');
});
